class Translation(object):
    START_TEXT = """Both username Changed to 👇. \n\n @UrlUpRobotV3_bot """
...
URL | filename | username | password"""
    ...
    DOWNLOAD_START = "📤 Your request is in the queue. Do not send another request..."
    UPLOAD_START = "Started to upload.."
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 1.5GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Your Request SuccessFully Completed"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds. And \nUploaded in {} seconds."
    NOT_AUTH_USER_TEXT = "Bot Under Maintenance. Please Check After Some Time "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/ShrimadhaVahdamirhS'>@SpEcHlDe</a>"
    SAVED_CUSTOM_THUMB_NAIL = "Custom thumbnail set. This image will be used in the video."
...
Expires on: {}"""
    HELP_USER = """👉 Sent me a Telegram document 
I Will Convert to Telegram Streamble videos

👉 use /convert2video command as a reply to document which you wanted to convert

👉 send image to set custom thumbnail for the videos

👉  You can use /delthumb to delete the auto generated thumbnail.

👉 If you find any Bugs Please Report @S8_DarkWarrior"""


    REPLY_TO_DOC_GET_LINK = "Reply to a Telegram media to get High Speed Direct Download Link"
    REPLY_TO_DOC_FOR_C2V = "Reply to some document file"
    REPLY_TO_DOC_FOR_RENAME_FILE = "Reply to a Telegram media to /rename with custom thumbnail"
    AFTER_GET_DL_LINK = "Direct Link generated 👇 \n \n  {} \n \n <i>Generated will expire in {} days.</i> \n"
